...
if(@tipoFiltro = 2)    
begin     
 insert into @result  values ('[Table("'+@obj+'Dto")]')          
 insert into @result  values ('public class '+@obj)          
 insert into @result  values ('{')          
 insert into @result  values (' ')          
...
begin    
 ...
 set @titpoFront = (case @tipo          
       WHEN 'varchar'        then ', type: ''number'', headerSize: 1.3'+ (case when @isnull = 1 then ', isNullable: true'  else '' end)            
       WHEN 'char'           then ', type: ''text'', headerSize:2.1' + (case when @isnull = 1 then ', isNullable: true'  else '' end)            
       WHEN 'nvarchar'       then ', type: ''text'', headerSize:2.1'+ (case when @isnull = 1 then ', isNullable: true'  else '' end)            
       WHEN 'nchar'          then ', type: ''text'', headerSize:2.1' + (case when @isnull = 1 then ', isNullable: true'  else '' end)            
       ...
       WHEN 'tinyint'        then ', type: ''number'', headerSize: 1.3' + (case when @isnull = 1 then ', isNullable: true'  else '' end)                 
